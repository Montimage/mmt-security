...
typedef struct rule_struct{
  ...
  tuple_t t;              //Only used by a LEAF in a EVENT or (t.valid, t.data) to store result from compute
...
static rule_t *top_rule = NULL;
static rule_t *bot_rule = NULL;
static father_t *top_father = NULL;
static father_t *bot_father = NULL;
static rule_t *root_rule;
