...
typedef struct mmt_sec_config_struct {
	...
	uint16_t threshold_size; //THRESHOLD_SIZE in number of packets. start mmt-sec processing from this number of reports
	uint32_t threshold_time; //THRESHOLD_TS in microseconds. start mmt-sec processing from this difference in timestamp
